...
import {
  ...
  CarouselContent,
  CarouselItem,
} from "@/components/ui/logos3-carousel";
    ...
    <section className="py-16">
      <div className="container mx-auto flex flex-col items-center text-center">
        <h1 className="my-6 text-2xl font-normal text-pretty lg:text-4xl">
          ...
          <span style={{ fontFamily: 'Arial Rounded MT Regular, Arial, sans-serif', fontWeight: '100' }}>
            {" "}these companies
          </span>
        </h1>
      </div>
          ...
          >
            <CarouselContent className="ml-0">
              {logos.map((logo) => (
                ...
                >
                  <div className="mx-15 flex shrink-0 items-center justify-center">
                    <div>
                      <img
                        src={logo.image}
                        alt={logo.description}
                        className={`${logo.className} grayscale opacity-60 hover:opacity-100 transition-opacity duration-300`}
                      />
                    </div>
                  </div>
                </CarouselItem>
